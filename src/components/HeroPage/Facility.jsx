...
const Facility = () => {
    ...
    return (
        <div id="care-section" className="relative z-20 mx-1 sm:mx-2 md:mx-3 lg:mx-4 xl:mx-6">
            <div className="backdrop-blur-md border-b border-white/30 rounded-xl sm:rounded-2xl pt-1 pb-4 sm:pb-6 w-full max-w-[1800px] mx-auto" style={{ backgroundColor: '#D9D9D933' }}>
