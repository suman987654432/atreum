...
const Excellence = () => {
    ...
    return (
        <section className="relative  py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-12 lg:px-20 overflow-hidden">
            ...
            {/* card slide  */}
            <div className="max-w-7xl mx-auto relative px-4 sm:px-8 md:px-12">
                {/* Slider Container */}
                ...
                <div className="flex justify-center gap-1.5 sm:gap-2 -mt-4 sm:-mt-6">
                    {doctorsData.map((_, index) => (
                        <button
                            ...
                            className={`h-2.5 sm:h-3 rounded-full transition-all ${(currentIndex % doctorsData.length) === index
