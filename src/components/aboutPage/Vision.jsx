        ...
        <section className="relative z-20 w-full px-3 sm:px-4 md:px-5  ">
            <div className="relative overflow-hidden rounded-[10px] sm:rounded-[14px] border border-[#8CE0DD] bg-[#43A1AF]">
                ...
                <div className="relative px-6 sm:px-8 md:px-12 lg:px-16 py-11 sm:py-12 md:py-14 lg:py-16">
                    <h2 className="text-white font-canela font-bold italic text-[1.35rem] sm:text-[1.55rem] md:text-[1.8rem] lg:text-[2.05rem] leading-[1.15]">
                        Our Vision, Mission & Core Values
                    </h2>

                    <div className="mt-10 sm:mt-12 grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 lg:gap-14">
                        <div className="space-y-8 sm:space-y-10 max-w-[33rem]">
                            <div>
                                <div className="flex items-center gap-3 sm:gap-4">
                                    <img src={vision} alt="Vision" className="w-11 h-11 sm:w-12 sm:h-12 object-contain" />
                                    <h3 className="text-white font-canela font-bold italic text-[1.4rem] sm:text-[1.55rem] leading-none">
                                        Vision
                                    </h3>
                                </div>
                                <p className="mt-3 text-white/95 font-canelaText font-light text-[21px] leading-[28px] tracking-[0em] max-w-[32ch]">
                            ...
                            <div>
                                ...
                                <p className="mt-3 text-white/95 font-canelaText font-light text-[21px] leading-[30px] tracking-[0em] max-w-[34ch]">
                        ...
                        <div className="max-w-[34rem]">
                            <h3 className="text-white font-canela font-bold italic text-[1.5rem] sm:text-[1.7rem] leading-none">
                                Core Values
                            </h3>
                                ...
                                {coreValues.map((value) => {
                                    return (
                                        <div key={value.id} className="flex items-center gap-2 sm:gap-3">
                                            ...
                                            />
                                            <p className="text-white/95 font-canelaText font-light text-[21px] leading-[30px] tracking-[0em]">
